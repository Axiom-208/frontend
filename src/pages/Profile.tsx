...
import {Book, BookOpen, GraduationCap, Video, Mail, Phone, Edit2, Save} from 'lucide-react';
...
const Profile = () => {
    ...
    //user stats
    const stats = [
        {label: 'Notes', value: user.notes.length, icon: Book, color: 'bg-blue-900'},
        {label: 'Chapters', value: user.chapters.length, icon: Video, color: 'bg-pink-400'},
        {label: 'Quizzes', value: user.quizzes.length, icon: GraduationCap, color: 'bg-amber-200'},
        {label: 'Flashcards', value: user.flashcards.length, icon: BookOpen, color: 'bg-orange-200'}
    ];
                ...
                <div className="mb-8 bg-white rounded-lg shadow-md p-6">
                    <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
                        <div className="relative">
                            <div
                                className="w-24 h-24 bg-blue-900 rounded-full flex items-center justify-center text-white text-3xl font-bold">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                        {stats.map((stat, index) => (
                            <div key={index} className="bg-white rounded-lg shadow-md p-4 flex items-center">
                                <div
                                    className={`${stat.color} w-12 h-12 rounded-full flex items-center justify-center mr-4`}>
